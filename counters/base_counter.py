...
class BaseCounter:
    ...
    def process_frame(self, frame):
        ...
        raise NotImplementedError("The process_frame method must be implemented by a subclass.")

    def draw_overlay(self, frame):
        """This method should be overridden by the child class."""
        raise NotImplementedError("The draw_overlay method must be implemented by a subclass.")